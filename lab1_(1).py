...
Original file is located at
    https://colab.research.google.com/drive/100r-6REhEydmr0F5zt-9R7nrCpN6mhMk
...
if side1<side2+side3 and side2<side1+side3 and side3<side1+side2:
  ...
  print(f"It is impossible to draw a triagle with {side1},{side2},{side3} sides.")
...
if operation == "+":
    ...
    if num2 == 0:
      print(f"You try to devide by {int(num2)} it is impossible.")
    else:
      result = num1 / num2
else:
    result = "Invalid operation"
